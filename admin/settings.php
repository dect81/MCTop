...
<form action="{$list_url}/admin/s/settings" method="post">
<fieldset>
...
EndHTML;
  ...
  function process() {
    ...
    $DB->query("UPDATE {$CONF['sql_prefix']}_settings SET list_name = '{$list_name}', list_url = '{$list_url}', default_language = '{$default_language}', your_email = '{$your_email}',
                num_list = {$num_list}, ranking_period = '{$ranking_period}', ranking_method = '{$ranking_method}', ranking_average = {$ranking_average}, featured_member = {$featured_member}, top_skin_num = {$top_skin_num}, fill_blank_rows = {$fill_blank_rows},
